...
$result = mysql_query("SELECT * FROM hosp_login WHERE email = '$get_email'");
...
else
{
	...
	// get customer 
	$result1 = mysql_query("INSERT INTO hosp_login (name, email, password, mobile,field_1,field_2,field_3,field_4, created_date)
