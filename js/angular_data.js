...
/****************************************************************************/
	...
	{		
		...
		.success(function(data, status, headers, config) 
		{
			...
			{
				alert("Created Successfully");
				window.location = "view_appoinment.html";
				return;				
			}
			else if(data.success == 2)
			{
	...
	{		
		...
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
				...
				window.location = "view_child.html";	
				return;
			}
...
/************************** Student Update *********************************/
/****************************************************************************/
$scope.update_child = function(cus_id,field_1,field_2,field_3,
								 field_4,field_5,field_6,field_7,field_8) 
	{
		window.location = "update_child.html";
	...
	$scope.save_child = function() 
	{		
		$http.post('save_child.php',{
...
$scope.update_status_hosp = function(cus_id,field_9) 
	{
	...
	{		
		$http.post('save_con_hosp_status.php',{
		 'cus_id':$scope.cook_con_id, 'field_9':$scope.cook_con_status, 'field_2':$scope.field_2})
		.success(function(data, status, headers, config) 
		{
			if(data.success == 1)
			{
